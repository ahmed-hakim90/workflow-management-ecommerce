...
export const commonText: Record<Locale, Record<string, string>> = {
  ...
  ar: {
    ...
    "Admin": "الإدارة",
    "Full calendar and scheduling will connect here.": "سيتم ربط التقويم الكامل والجدولة هنا.",
    "Page filters": "فلاتر الصفحة",
    "Use the filters on this page.": "استخدم الفلاتر في هذه الصفحة.",
    "Jump to filters": "الانتقال إلى الفلاتر",
    "Filter tools for this view are not available on this page.": "أدوات الفلاتر لهذا العرض غير متوفرة في هذه الصفحة.",
    ...
    "Use Supabase sign-in or add a staff API key in Settings after you sign in.": "استخدم تسجيل الدخول عبر Supabase أو أضف مفتاح API للموظفين من الإعدادات بعد تسجيل الدخول.",
    ...
    "Customer": "العميل",
    "Address": "العنوان",
    "No address on file.": "لا يوجد عنوان في السجل.",
    "Open full order page": "فتح صفحة الطلب كاملة",
    "Loading line items…": "جارٍ تحميل بنود الطلب…",
    "Total": "الإجمالي",
    "Date": "التاريخ",
    "Actions": "الإجراءات",
    "Role": "الدور",
    ...
    "confirmed": "مؤكد",
    "invoice_required": "بانتظار الفاتورة",
    "invoiced": "تمت الفوترة",
    "ready_for_shipping": "جاهز للشحن",
    "awb_created": "تم إنشاء بوليصة الشحن",
    "warehouse_picking": "جاري التجهيز في المخزن",
    "warehouse_packed": "تم التغليف",
    "out_for_shipping": "خرج للشحن",
    "delivered": "تم التسليم",
    "failed_delivery": "فشل التسليم",
    "returned": "تم الإرجاع",
    "exchange_requested": "طلب استبدال",
    "replacement_created": "تم إنشاء بدل",
    "cancelled": "ملغي",
    "Status pipeline": "مراحل سير الطلب",
    "Confirm order": "تأكيد الطلب",
    "Request invoice": "طلب الفاتورة",
    "Issue invoice": "إصدار الفاتورة",
    "Mark ready for shipping": "تجهيز للشحن",
    "Create AWB": "إنشاء بوليصة شحن",
    "Start picking": "بدء التجهيز",
    "Mark packed": "تأكيد التغليف",
    "Dispatch": "تسليم لشركة الشحن",
    "Mark delivered": "تأكيد التسليم",
    "Mark failed delivery": "فشل التسليم",
    "Retry delivery": "إعادة محاولة التسليم",
    "Open return": "فتح طلب إرجاع",
    "Open exchange": "فتح طلب استبدال",
    "Create replacement": "إنشاء بدل",
    "Close order": "إغلاق الطلب",
    "Cancel order": "إلغاء الطلب",
    "Invalid status transition": "تحويل غير مسموح به",
    "Invoice required before shipping": "لازم تصدر الفاتورة قبل الشحن",
    "AWB required before warehouse can pack": "لازم يكون فيه بوليصة شحن قبل التغليف",
    "Action not allowed for your role": "ده مش من صلاحياتك",
    "Add a note": "أضف ملاحظة",
    "Required note": "السبب مطلوب",
    "Drop here": "اسحب هنا",
    "paid": "مدفوع",
    "unpaid": "غير مدفوع",
    ...
    "Use the email and password for your Supabase account.": "استخدم البريد وكلمة المرور لحساب Supabase الخاص بك.",
    ...
    "Mock mode: no Supabase needed. After signup you are signed in automatically; save the staff API key for API scripts.":
      "وضع تجريبي: لا حاجة لـ Supabase. بعد التسجيل تُسجَّل دخولك تلقائيًا؛ احفظ مفتاح API للموظفين لاستخدامه في السكربتات.",
    "Creates a Supabase Auth user and your company tenant.": "ينشئ مستخدم Supabase Auth ومستأجر شركتك.",
    ...
    "Supabase is not configured for this deployment.": "لم يُضبط Supabase لهذا النشر.",

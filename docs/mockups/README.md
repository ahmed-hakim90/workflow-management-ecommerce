# Stitch reference exports

PNG snapshots copied from project chat assets for visual parity checks.

| File | Screen |
|------|--------|
| `SCREEN_10_landing.png` | Marketing landing |
| `SCREEN_8_orders.png` | Orders table |
